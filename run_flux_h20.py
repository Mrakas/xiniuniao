...
PROMPT = "A cinematic shot of a baby raccoon wearing a tiny wizard hat, casting a spell, detailed, 8k"
'''
"A majestic cat knight in shining armor, holding a glowing sword, standing on a castle parapet with a dragon flying in the background under a starry night."
"An enormous, ancient clock made of cracked marble and brass, half-submerged in a calm ocean. The clock's hands are frozen, pointing to thirteen. Instead of numbers, the clock face has intricate constellations carved into it. Sunlight breaks through the water's surface, creating shimmering god rays that illuminate the clock's weathered details. Surreal, melancholic, high-resolution photography."
'''
# 树搜索配置
BRANCH_FACTOR = 4     
